...
def create_optimized_gengar():
    purple = (0.35, 0.18, 0.48, 1.0)
    dark_purple = (0.18, 0.12, 0.28, 1.0)
    red = (0.95, 0.08, 0.12, 1.0)
    ...
    # === BODY - lower resolution metaball ===
    ...
    tongue_mball.data.resolution = 0.2
    ...
    # === TEETH ===
    for i, pos in enumerate([(-0.4, 0.7, 0.45), (-0.2, 0.72, 0.5), (0, 0.73, 0.52), (0.2, 0.72, 0.5), (0.4, 0.7, 0.45)]):
        bpy.ops.mesh.primitive_cone_add(radius1=0.04, depth=0.12, location=pos, rotation=(math.radians(-20), 0, 0))
    ...
    print("Optimized Gengar created!")
    return camera
